...
|:-----------| :--- | :--- | :--- |
| 2026-01-27 | v1.0 | [SSP-MMC Algorithm Spec v1.0](./algorithms/2026-01-27_SSP-MMC_Spec_v1.0.md) | Implementation guide for the DHP model (Ear Training adapted) and CSV lookup logic. |
| 2026-01-22 | - | [Original Paper (Maimemo)](./algorithms/references/maimemo.pdf) | Reference paper: "A Stochastic Shortest Path Algorithm for Optimizing Spaced Repetition". |
